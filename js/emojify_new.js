   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            var defaultConfig = {
                ...
                mode: 'img',
                url_attr:'',
                ph_src:'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY3j37t1/AAliA8r60tGjAAAAAElFTkSuQmCC'
            };
            ...
            function insertEmojicon(args) {
                ...
                if(args.replacer){
                    ...
                    if (elementType !== 'img') {
                        ...
                        if(defaultConfig.url_attr){
                            emojiElement.setAttribute(defaultConfig.url_attr, defaultConfig.img_dir + '/' + args.emojiName + '.png');
                            emojiElement.setAttribute('src', defaultConfig.ph_src);
                        }else{
